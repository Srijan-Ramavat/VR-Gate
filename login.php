<?php
  ...
  if(isset($_POST['user']))
  {
    ...
    $sql = "SELECT user FROM login WHERE pwd = $pwd";
    ...
    if ($result->num_rows > 0) {
      ...
      echo "<script>alert(\"ERROR : Wrong ID & Password. & Suggestion : Change a few things & try again.\");</script>";
      echo<<< END
      	...
      	<body>
      		...
      		<div id="fh5co-contact" class="animate-box">
      			<div class="container">
      				...
      				<div class="col-md-6">
      							<div class="row">
      							<h3 class="section-title">Log In, my Friend.</h3>
      								<div class="col-md-8">
      					...
      					<div class="row">
      					<div class="col-md-6">
      							<h3 class="section-title">Haven't Joined us yet?</h3>
      							<p>Don't fear, for we are here. Register Now, suit up <br>& get ready to teleport to virtual space!</p>
